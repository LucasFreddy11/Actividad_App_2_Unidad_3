...
def agregar_prestamo():
    if request.method == 'POST':
        ...
        fecha_devolucion = request.form['fecha_devolucion']  # Asegúrate de recoger este campo del formulario.
        cur = mysql.connection.cursor()
        # Incluye la fecha_devolucion en la lista de campos y en los valores.
        cur.execute("INSERT INTO Prestamos (id_libro, id_usuario, fecha_prestamo, fecha_devolucion) VALUES (%s, %s, %s, %s)",
